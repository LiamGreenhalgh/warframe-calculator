...
export const FORMULA_CATALOG: FormulaDoc[] = [
  ...
  {
    id: "violet-electricity-hypothesis",
    category: "shards",
    name: "Violet electricity — community hypothesis",
    formula: "1 + (0.45 + 0.15(x − 1)) × x",
    stacking: "additive",
    source: { title: "User hypothesis (not official)", url: "https://wiki.warframe.com/w/Violet_Archon_Shard" },
    notes: "Treats +15% as 'each other purple' and ignores Crimson/Azure eligibility. Shown only as a comparison. Wiki explicitly counts the originating shard in N, so 1 Tauforged electricity is 60%, not 45%.",
    kind: "hypothesis",
    example: "x=5 → 5.25 vs wiki 6.00",
  },
  {
